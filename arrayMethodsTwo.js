...
// console.log(runningThroughNumbers);
...
const iCitesAtBeginning = cities.filter((cityName) => cityName.endsWith("i"))

console.log(iCitesAtBeginning)
...
fruits.forEach( function(elementFruit, indexFruit) {
  if (elementFruit.color === "red") {
    console.log("The fruid with index " + indexFruit + " is an apple.")
  } else if (elementFruit.color === "orange") {
    console.log("The fruit with index " + indexFruit + " is an orange")
  } else {
    console.log("The fruit with index " + indexFruit + " is neighter apple of orange.")
  }
})
console.log("----------")
...
// The fruit with index 0 is neighter apple of orange.
// The fruit with index 1 is an orange
// The fruit with index 2 is neighter apple of orange.
// The fruid with index 3 is an apple.
...
const totalRice = foods.filter((foodName) => foodName.tags.includes("rice")).reduce((a, c) => (a + c.price), 0)
